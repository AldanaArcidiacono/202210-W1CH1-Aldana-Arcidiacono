const questions = [
    ...
    [
        ...
        },
        {
            ...
            status: 0,
            question:
                "CON LA B. Abertura por donde se echan las cartas por el correo.",
        },
        {
            letter: "c",
            answer: "chandal",
        ...
        },
        {
            ...
            status: 0,
            question:
                "CON LA G. Nombre de uno de los buscadores online más utilizados.",
        },
        {
            letter: "h",
            answer: "hombrera",
        ...
        },
        {
            ...
            status: 0,
            question:
                "CON LA K. Medida de longitud que equivale a 1000 metros.",
        },
        {
            letter: "l",
            answer: "linguistica",
            status: 0,
            question:
                "CON LA L. Estudio científico del orígen, la evolución y estructura del lenguaje.",
        },
        {
            letter: "m",
            answer: "menor",
        ...
        },
        {
            ...
            status: 0,
            question:
                "CON LA N. Cada una de las fabulosas deidades de las aguas, bosques o selva.",
        },
        {
            letter: "ñ",
            answer: "ñoqui",
            status: 0,
            question:
                "CON LA Ñ. Tipo de pasta italiana, elaborada con patata, harina y queso de ricota.",
        },
        {
            letter: "o",
            answer: "oscar",
            status: 0,
            question:
                "CON LA O. Nombre con el que es conocido popularmente, el Premio de la Academia de Artes y Ciencias Cinematográficas.",
        },
        {
            letter: "p",
            answer: "prioridad",
            status: 0,
            question:
                "CON LA P. Ventaja o preferencia que una persona o cosa tiene sobre otra.",
        },
        {
            letter: "q",
            answer: "branquia",
        ...
        },
        {
            ...
            answer: "ron",
            status: 0,
            question: "CON LA R. Nombre del mejor amigo de Harry Potter.",
        },
        {
            letter: "s",
            answer: "samba",
        ...
        },
        {
            ...
            status: 0,
            question:
                "CON LA T. Película de Disney, en la que el personaje principal es criado por gorilas.",
        },
        {
            letter: "u",
            answer: "usurpar",
        ...
        },
        {
            ...
            status: 0,
            question:
                "CON LA W. Deporte de pelota que se juega en la piscina y en el que se enfrentan dos equipos.",
        },
        {
            letter: "x",
            answer: "oxford",
        ...
        },
        {
            ...
            status: 0,
            question:
                "CON LA Y. Reconocida cancion de Village People, lanzada en 1978.",
        },
        {
            letter: "z",
            answer: "zapatilla",
            status: 0,
            question:
                "CON LA Z. Calzado ligero y cómodo, con o sin talón, de tela o cuero fino y suela plana de grosor variable, que se usa dentro de casa.",
        },
    ],
    [
        {
        ...
        },
        {
            ...
            status: 0,
            question:
                "CON LA B. Reconocida banda de rock britanica, durante los años 60'.",
        },
        {
            letter: "c",
            answer: "caracol",
            status: 0,
            question: "CON LA C. Animal que se mueve lentamente.",
        },
        {
            letter: "d",
            answer: "dormir",
            status: 0,
            question:
                "CON LA D. Estar de reposo que consiste en la inacción o suspensión de los sentidos y de todo movimiento voluntarios.",
        },
        {
            letter: "e",
            answer: "eleven",
            status: 0,
            question:
                "CON LA E. Nombre del personaje protagonista de Stranger Things.",
        },
        {
            letter: "f",
            answer: "finn",
            status: 0,
            question:
                "CON LA F. Nombre del personaje principal de la serie animada Hora de Aventura.",
        },
        {
            letter: "g",
            answer: "gato",
            status: 0,
            question: "CON LA G. Felino.",
        },
        {
            letter: "h",
            answer: "hawai",
            status: 0,
            question:
                "CON LA H. Lugar donde transcurre la película de Lilo y Stitch.",
        },
        {
            letter: "i",
            answer: "inapetencia",
        ...
        },
        {
            ...
            status: 0,
            question:
                "CON LA K. Fruto de forma ovoide, de tamaño variable y recubierto de una piel fina de color marrón, ligeramente vellosa.",
        },
        {
            letter: "l",
            answer: "lobera",
        ...
        },
        {
            ...
            status: 0,
            question:
                "CON LA Ñ. Ave corredora similar al avestruz, pero de menor tamaño, habita en las llanuras de América del Sur.",
        },
        {
            letter: "o",
            answer: "organo",
            status: 0,
            question:
                "CON LA O. Parte del animal o vegetal que ejerce una función.",
        },
        {
            letter: "p",
            answer: "perro",
            status: 0,
            question: "CON LA P. El mejor amigo del hombre.",
        },
        {
            letter: "q",
            answer: "arquero",
            status: 0,
            question: "CONTIENE LA Q. Soldado que dispara flechas con un arco.",
        },
        {
            letter: "r",
            answer: "rafaga",
        ...
        },
        {
            ...
            status: 0,
            question:
                "CON LA W. Tecnología que permite conectar diferentes equipos informaticos a través de una red inalámbrica de banda ancha.",
        },
        {
            letter: "x",
            answer: "fenix",
            status: 0,
            question:
                "CONTIENE LA X. Ave fabulosa, semejante a un águila, que renacía de sus propias cenizas.",
        },
        {
            letter: "y",
            answer: "moncayo",
...
const abcQuestions = (array) => {
    const { letter } = array[iterator];
    if (
        array[iterator].status === statusNotPlayed ||
...
const exitTheGame = () => {
    ...
    userActions.style.display = "none";
    const usersLastMessage = document.querySelector(
...
const endGame = (array) => {
    if (
        hasTimeToPlay &&
        (!stillInPasapalabra(array) || !stillNotPlayedLetters(array))
    ) {
...
const playAgain = (array) => {
    for (let i = 0; i < array.length; i++) {
        document.getElementById(`${array[i].letter}`).style.background =
            "#EDBCD0";
